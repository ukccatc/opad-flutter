...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
  ...
  Future<void> _handleResetPassword() async {
    ...
    Logger.info('✅ [RESET_SCREEN] Form validation passed');

    if (_passwordController.text != _confirmPasswordController.text) {
      Logger.warning('❌ [RESET_SCREEN] Passwords do not match');
      setState(() {
    ...
    Logger.info('✅ [RESET_SCREEN] Passwords match');
    ...
    try {
      ...
      Logger.error('❌ [RESET_SCREEN] Exception during password reset', e);
      setState(() {
